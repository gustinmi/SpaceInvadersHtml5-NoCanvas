...
FSHOOTER.resourceManager.prototype = {
    add: function(name, resObj) {
        if (this.registered[name]) throw '[FSHOOTER.resourceManager.add] The resource name "' + name + '" is already registered.';
        this.registered[name] = resObj || {};
    },
    get : function(name){
    ...
    function fire() {
        ...
        },
        {
            ...
            start : function(){
                ...
                new Audio(runtime.shootAudio).play();
            },
            ...
            step: function() {
                ...
                if(hitList && hitList.length > 0){
                    new Audio(runtime.killedAudio).play();

                    //hitList[0].remove();
                    $(hitList[0]).toggleClass("new").css("opacity", ".1");
